...
from utils.losses import get_loss, list_losses, LogCoshLoss, WeightedMSELoss
...
class TestGetLoss:
    ...
    @pytest.mark.parametrize("loss_name", ['mse', 'mae', 'huber', 'smooth_l1', 'log_cosh', 'weighted_mse'])
...
class TestLossGradients:
    ...
    @pytest.mark.parametrize("loss_name", ['mse', 'mae', 'huber', 'log_cosh', 'weighted_mse'])
