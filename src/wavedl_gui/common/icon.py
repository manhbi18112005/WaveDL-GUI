...
class Icon(FluentIconBase, Enum):
    ...
    def path(self, theme=Theme.AUTO):
        return f":/src/wavedl_gui/images/icons/{self.value}_{getIconColor(theme)}.svg"
...
class Ico(FluentIconBase, Enum):
    ...
    def path(self, theme=Theme.AUTO):
        return f":/src/wavedl_gui/images/ico/{self.value}.ico"
...
class PNG(FluentIconBase, Enum):
    ...
    def path(self, theme=Theme.AUTO):
        return f":/src/wavedl_gui/images/png/{self.value}.png"
