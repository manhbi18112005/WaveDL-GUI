...
class BaseModel(nn.Module, ABC):
    ...
    @abstractmethod
    def __init__(self, in_shape: Union[Tuple[int], Tuple[int, int], Tuple[int, int, int]], out_size: int, **kwargs):
        """
    ...
    def get_optimizer_groups(self, base_lr: float, weight_decay: float = 1e-4) -> list:
        ...
        return groups if groups else [{"params": self.parameters(), "lr": base_lr, "weight_decay": weight_decay}]
